...
CREATE TABLE Equipment (
    SerialNumber INT,
    Type ENUM ('autorack', 'boxcar', 'caboose', 'flatcar', 'gondola', 'hopper', 'locomotive', 'spine car', 'tank car'),
    Price DECIMAL(10,2),
    Manufacturer VARCHAR(50),
    Capacity INT DEFAULT 200000,
...
CREATE TABLE Reservation (
    ...
    CONSTRAINT PKReservation PRIMARY KEY (TrainNumber, SerialNumber)
);
